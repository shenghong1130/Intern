...
def load_tag_pos():
    ...
    tag_poses["2"] = expand_2("2", [196, 5])
    tag_poses["3"] = expand_2("3", [221, 5])
    tag_poses["4"] = expand_2("4", [221, 30])

    tag_poses["5"] = expand_2("5", [116.5, 31.5])
    tag_poses["6"] = expand_2("6", [116.5, 6.5])
    tag_poses["7"] = expand_2("7", [141.5, 6.5])
    tag_poses["8"] = expand_2("8", [141.5, 31.5])

    tag_poses["9"] = expand_2("9", [14.5, 79.5])
    tag_poses["10"] = expand_2("10", [14.5, 54.5])
    tag_poses["11"] = expand_2("11", [39.5, 54.5])
    tag_poses["12"] = expand_2("12", [39.5, 79.5])

    tag_poses["13"] = expand_2("13", [69.5, 206])
    tag_poses["14"] = expand_2("14", [69.5, 181])
    tag_poses["15"] = expand_2("15", [94.5, 181])
    tag_poses["16"] = expand_2("16", [94.5, 206])

    tag_poses["17"] = expand_2("17", [92, 288])
    tag_poses["18"] = expand_2("18", [92, 263])
    tag_poses["19"] = expand_2("19", [117, 263])
    ...
    tag_poses["25"] = expand_2("25", [235.0, 271.5])
    tag_poses["26"] = expand_2("26", [235.0, 246.5])
    tag_poses["27"] = expand_2("27", [260.0, 246.5])
    tag_poses["28"] = expand_2("28", [260.0, 271.5])

    tag_poses["29"] = expand_2("29", [235.5, 170.8])
    tag_poses["30"] = expand_2("30", [235.5, 145.8])
    tag_poses["31"] = expand_2("31", [260.5, 145.8])
    tag_poses["32"] = expand_2("32", [260.5, 170.8])

    tag_poses["33"] = expand_2("33", [158, 110])
    tag_poses["34"] = expand_2("34", [158, 85])
    tag_poses["35"] = expand_2("35", [183, 85])
    tag_poses["36"] = expand_2("36", [183, 110])
    return tag_poses
