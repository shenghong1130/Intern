...
def parse_args(argv=None):
    ...
    parser.add_argument("--skip-change", "--skip-api", dest="skip_change", action="store_true", help="classify at the configured target standoff but skip the 10 cm action, arm motion, and Worker request")
