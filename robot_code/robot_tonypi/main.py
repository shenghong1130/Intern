...
def parse_args(argv=None):
    ...
    parser.add_argument("--skip-change", "--skip-api", dest="skip_change", action="store_true", help="classify at the 25 cm target but skip the 15 cm action, arm motion, and Worker request")
