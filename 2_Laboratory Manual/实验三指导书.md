...
![alt text](实验三指导书_assets/image_08.png)

![alt text](实验三指导书_assets/image_09.png)
...
输入：
 ...
 - distCoeffs：相机畸变系数数组，本实验示例使用 5 个参数。
